...
#model.load_weights('weights/vgg_base/checkpoint')
...
save_list(history_train_loss, 'logs/%s_train_loss.csv'%('vgg_base'))
save_list(history_train_acc, 'logs/%s_history_train_acc.csv'%('vgg_base'))
save_list(history_test_loss, 'logs/%s_history_test_loss.csv'%('vgg_base'))
save_list(history_test_acc, 'logs/%s_history_test_acc.csv'%('vgg_base'))
